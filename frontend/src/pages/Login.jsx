      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4">
        <div className="w-full max-w-md space-y-8 py-12">
          <div className="text-center mb-2">
            <h2 className="text-3xl font-bold text-primary-900 dark:text-white mb-1">Welcome back</h2>
            <p className="text-primary-700 dark:text-primary-200">Sign in to your account</p>
          </div>
          <div className="bg-white dark:bg-secondary-800 rounded-xl shadow-lg border border-primary-200 dark:border-secondary-700 px-8 py-8">
            ...
            <p className="mt-6 text-center text-sm text-primary-600 dark:text-primary-200">
              ...
              <Link to="/register" className="text-primary-700 dark:text-primary-300 hover:text-primary-900 dark:hover:text-primary-100 font-medium">
                Sign up
              </Link>
            </p>
          </div>
